<?php
$destinataire = 'david.thewissen@gmail.com';

if(isset($_POST['submit'])){
  $nom=($_POST['name']);
  $mail=($_POST['mail']);
  $message=($_POST['message']);
  $form_mail ="Message de : $nom \n";
  $form_mail .= "Email : $mail\n";
  $form_mail .= "Message : $message\n";
}
  mail("$destinataire","Contact for Stage","$form_mail","From: $mail");
    ...
    <div class="contact">
      <form class="form" action="index.php" method="post" >
        ...
        <p><label class="testname" for="email">Mail :</label>
  			<input type="email" id="mail" name="mail"  placeholder="john.doe@mail.com" required>
        </p>
